...
export default function Home() {
  return (
    <div>
      ...
      <div
        id="SkillsLink"
        className="10sp-2 absolute top-0 z-50 mt-[calc(100vh+30rem)]"
      />
      <div
        id="ExperienceLink"
        className="10sp-2 absolute top-0 z-50 mt-[calc(200vh+26rem+7vmin)]"
      />
      <div
        id="CertificationsLink"
        className="10sp-2 absolute top-0 z-50 mt-[calc(294vh+22rem+14vmin)]"
      />
      <div
        id="EducationLink"
        className="10sp-2 absolute top-0 z-50 mt-[calc(384vh+18rem+21vmin)]"
      />
      <div
        id="ExtracurricularLink"
        className="10sp-2 absolute top-0 z-50 mt-[calc(468vh+14rem+28vmin)]"
      />
      ...
      <div className="bg-[#5d5388] rounded-t-[20vmin] custom-color_change">
        ...
        <div className="sticky top-[4rem]">
          <a
            id="SkillStack"
            href="#SkillsLink"
            className="custom-manilla-header"
          >
            Skills Stack
          </a>
          <div className="text-center h-full custom-manilla-folder">
            <Skill
              ...
              flexElement={
                <div className="flex">
                  <TechIcon
                    tech_skill="Formit Pro"
                    icon_pic="/images/skills/formit_logo.png"
                  />
                  <TechIcon
                    tech_skill="AutoCAD"
                    icon_pic="/images/skills/autocad_logo.png"
                  />
                  <TechIcon
                    tech_skill="Revit"
                    icon_pic="/images/skills/revit_logo.png"
                  />
                  <TechIcon
                    tech_skill="ArchiCAD"
                    icon_pic="/images/skills/archicad_logo.png"
                  />
                  <TechIcon
                    tech_skill="SketchUp"
                    icon_pic="/images/skills/sketchup_logo.svg"
                  />
                </div>
              }
            />
            <Skill
              ...
              flexElement={
                <div className="flex">
                  <TechIcon
                    tech_skill="D5 Render"
                    icon_pic="/images/skills/d5_logo.png"
                  />
                  <TechIcon
                    tech_skill="Lumion"
                    icon_pic="/images/skills/lumion_logo.svg"
                  />
                  <TechIcon
                    tech_skill="Enscape"
                    icon_pic="/images/skills/enscape_logo.png"
                  />
                </div>
              }
            />
            <Skill
              ...
              flexElement={
                <div className="flex">
                  <TechIcon
                    tech_skill="Photoshop"
                    icon_pic="/images/skills/photoshop_logo.svg"
                  />
                  <TechIcon
                    tech_skill="Illustrator"
                    icon_pic="/images/skills/illustrator_logo.svg"
                  />
                  <TechIcon
                    tech_skill="InDesign"
                    icon_pic="/images/skills/indesign_logo.svg"
                  />
                </div>
              }
            />
        ...
        <div className="sticky top-[calc(4rem+7vmin)] mt-[-4rem]">
          <a href="#ExperienceLink" className="custom-manilla-header">
            Experience
          </a>
                ...
                <ul>
                  ...
                  <div className="flex flex-wrap">
                    ...
                    <div className="text-[3vmin] mt-[2vh] min-w-1/2">
                      ...
                      <ul className="list-disc ml-[5vw]">
                        <li>Top Defense Companies in Washington, DC</li>
                        <li>Company Headquarters</li>
                        <li>Large & Medium Architecture Firms</li>
                        <li>Passion Projects to Skyscrapers</li>
                      </ul>
                    </div>
                  </div>
                </ul>
        ...
        <div className="sticky top-[calc(4rem+14vmin)] mt-[-4rem]">
          <a href="#CertificationsLink" className="custom-manilla-header">
            Certifications
          </a>
          <div className="h-[90%] custom-inner_bottom_shadow custom-manilla-folder">
            <Certification
              logo="/images/certification/osha.svg"
              message="OSHA 10 Certification | 2019"
            />
          </div>
        </div>

        <div className="sticky top-[calc(4rem+21vmin)] mt-[-4rem]">
          <a href="#EducationLink" className="custom-manilla-header">
            Education
          </a>
        ...
        <div className="sticky top-[calc(4rem+28vmin)] mt-[-4rem]">
          <a href="#ExtracurricularLink" className="custom-manilla-header">
            Leadership | Extracurriculars
          </a>
          <div className="h-[80%] custom-inner_bottom_shadow custom-manilla-folder">
            <Extracurricular
              curricular="Morrisville Tutoring"
              position="Peer Tutor"
              message="asdf"
            />
          </div>
